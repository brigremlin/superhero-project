class SuperheroesController < ApplicationController
    ...
    def superhero_params
        params.require(:superhero).permit(:name, :full_name, :place_of_birth, :image, :gender, :height, :weight, :universe, :intelligence, :strength, :speed, :power, category_ids:[], universe_ids:[])
    end
end